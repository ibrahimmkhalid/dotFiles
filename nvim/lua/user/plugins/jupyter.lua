return {
  ...
  config = function ()
    ...
    vim.api.nvim_set_keymap("n", "<leader>jj", "/# %%<CR>j<Cmd>nohl<CR>", { silent = true, noremap = true, desc = "Jump to next cell"})
    vim.api.nvim_set_keymap("n", "<leader>jk", "/# %%<CR>NNj<Cmd>nohl<CR>", { silent = true, noremap = true, desc = "Jump to previous cell"})
  end
}
